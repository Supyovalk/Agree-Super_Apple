...
public class SuspiciousAppleItem
    ...
    public SuspiciousAppleItem(Properties p_43257_) {
        super(p_43257_);
    }

    @Override
    public void appendHoverText(ItemStack p_260314_, TooltipContext p_333118_, List<Component> p_259700_, TooltipFlag p_260021_) {
